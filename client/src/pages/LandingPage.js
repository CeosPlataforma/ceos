                ...
                <div className="container container-padding--light visao-geral" id="visao-geral">
                    ...
                    <div className="row mb-4 mb-xl-0">
                        <div className="col-sm-4 mb-4 mb-md-0">
                            <button className="visao-geral--btn--active" id="btn--organizacao">
                                Organização
                            </button>
                        </div>

                        <div className="col-sm-4 mb-4 mb-md-0">
                            <button className="visao-geral--btn--inactive" id="btn--gerenciamento">
                                Gerenciamento
                            </button>
                        </div>

                        <div className="col-sm-4">
                            <button className="visao-geral--btn--inactive" id="btn--desempenho">
                                Desempenho
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="row align-items-center visao-geral--content">
                        ...
                        <div className="col-sm-12 col-xl-5">
                            <img src={org} className="d-none d-xl-block mx-auto img-fluid visao-geral--content--img" id="visao-geral--img" alt="Imagem de Organização - Ceos" width="700px" height="100%" />
                        </div>
                    </div>
                </div>
