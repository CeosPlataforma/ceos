        ...
        <Col>
            <div className="msg-box mb-4">
                ...
                <div className="d-flex justify-content-between mt-4">
                    <button className="btn--secondary w-50 red-btn" onClick={() => { deletar(ticket.uuid, index) }}>Excluir</button>
                    {!ticket.resolvido && <button className="btn--secondary w-50 btn-solved" onClick={() => { resolver(ticket.uuid, index) }} >Marcar como resolvido</button>}
                </div>
            </div>
        </Col>
    );
