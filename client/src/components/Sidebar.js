...
class Sidebar extends Component {
                    ...
                    <div className="logo">
                        <svg version="1.1" id="LogoOfc__Branco_1_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                            ...
                            <g id="Logo_1_">
                                <g id="Elipse_1">
                                    <g>
                                        <circle class="st0" cx="360.9" cy="301.03" r="298.65" />
                                    </g>
                                </g>
                                <g id="Coruja_1_">
                                    <polygon class="st1" points="410.91,436.31 410.17,435.69 495.38,336.65 496.12,337.27" />
                                    <g id="Corpo_2_">
                                        <g id="Pés">
                                            <g>
                                                <path class="st2" d="M424.02,486.88c-1.42-2.99-4.61-5.39-10.41-6.63c-9.21-1.96-15.72,2.73-25.56,0.95
                                        ...
                                        <g id="Corpo">
                                            <g>
                                                <path class="st3" d="M503.54,104.43c-3.11-3.62-7.62-7.54-13.25-11.36c-8.04-5.46-16.71-9.2-28.4-12.31
                                    ...
                                    <g id="Rosto">
                                        <g>
                                            <path class="st4" d="M500.47,113.45c-5.6-8.78-11.82-14.22-17.72-17.72c-8.52-5.05-18.31-7.43-28.35-7.09
                                    ...
                                    <g id="Olhos_x2F_Bico">
                                        <g>
                                            <path class="st5" d="M401.01,135.95c-4.22,0-7.65,4.47-7.65,9.99c0,5.52,3.42,9.99,7.65,9.99c4.22,0,7.65-4.47,7.65-9.99
                                ...
                                <g id="Constelação">
                                    <g>
                                        <path class="st1" d="M413.03,421.89c-7.05-1.49-13.96,2.94-15.44,9.9c-0.4,1.89-0.35,3.76,0.07,5.53l-24.19,3.39
                            ...
                            <g id="CEOS">
                                <text transform="matrix(0.99 0 0 1.03 197.4575 716.0029)" class="st0 st6 st7 st8">CEOS</text>
                            </g>
                        </svg>
                    </div>
                </div>
                <ul className="nav_list">
                    ...
                    <li>
                        <Link id={window.location.pathname === "/materias" ? "active" : ""} to={"/materias"}>
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                viewBox="0 0 425.139 425.139" xmlSpace="preserve">
	...
	V40.384z M353.74,175.204h-78.774c-4.971,0-9,4.029-9,9s4.029,9,9,9h78.774c4.971,0,9-4.029,9-9S358.71,175.204,353.74,175.204z
	 ...
	 M335.021,212.978h-41.336c-4.971,0-9,4.029-9,9s4.029,9,9,9h41.336c4.971,0,9-4.029,9-9S339.992,212.978,335.021,212.978z"/></svg>
